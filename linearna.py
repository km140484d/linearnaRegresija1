...
predictors = 6                                  # inicijalan broj prediktora 5 + 1 (kolona sa 1)
...
print('Polinomska, min(J):', J_arr[J_min_index])
print('predictor_number_opt:', predictors_arr[J_min_index])
plt.plot(predictors_arr, J_arr, label='polynomial')
plt.legend()
plt.show()
# podesavanje prediktora, na model koji daje najbolje rezultate u polinomskoj regresiji
